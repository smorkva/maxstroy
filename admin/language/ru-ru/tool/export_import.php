...
// Text
$_['text_success']                          = 'Готово: Ваши данные полностью загружены!';
$_['text_success_settings']                 = 'Готово: Настройки экспрорта/импорта полностью сохранены!';
$_['text_export_type_category']             = 'Категории (включая описание и фильтры категорий)';
$_['text_export_type_category_old']         = 'Категории';
$_['text_export_type_product']              = 'Товары (описание, опции, дисконты, отзывы, атрибуты и фильтры)';
$_['text_export_type_product_old']          = 'Товары (описание, опции, дисконты, отзывы и атрибуты)';
$_['text_export_type_option']               = 'Опции товаров';
$_['text_export_type_attribute']            = 'Атрибуты товаров';
...
$_['text_loading_notifications']            = 'Проверка обновлений';
$_['text_retry']                            = 'Повторить';

// Entry
$_['entry_import']                          = 'Загрузка файлов Excel (XLS, XLSX or ODS)';
$_['entry_export']                          = 'Выгрузка требуемых данных в файл Excel (XLSX).';
$_['entry_export_type']                     = 'Выберите данные, которые хотите выгрузить:';
$_['entry_range_type']                      = 'Укажите диапазон выгрузки, если нужна частичная выгрузка:';
$_['entry_start_id']                        = 'Начиная с:';
$_['entry_start_index']                     = 'Counts per batch:';
$_['entry_end_id']                          = 'По:';
$_['entry_end_index']                       = 'The batch number:';
$_['entry_incremental']                     = 'Use incremental Import';
$_['entry_upload']                          = 'Файл загружен';
...
$_['entry_settings_use_export_cache']       = 'Использовать phpTemp кэш для экспорта большого объема данных(будет немного медленнее)';
$_['entry_settings_use_import_cache']       = 'Использовать phpTemp кэш для импорта большого объема данных(будет немного медленнее)';
...
// Button labels
$_['button_import']                         = 'Импортировтаь';
$_['button_export']                         = 'Экспортировать';
$_['button_settings']                       = 'Сохранить настройки';
$_['button_export_id']                      = 'по номеру';
$_['button_export_page']                    = 'по партиям';

// Help
$_['help_range_type']                       = '(Если требуется выгрузить все, то оставьте пустым)';
$_['help_incremental_yes']                  = '(Оставить прежний каталог. В случае совпадений, перезаписывать данными из листа Excel)';
$_['help_incremental_no']                   = '(Удалить старые перед загрузкой)';
$_['help_import']                           = 'Таблица может содержать категории , товары , определения атрибутов , параметры определений, или описания фильтров.';
$_['help_import_old']                       = 'Таблица может содержать категории , товары , определения атрибутов , параметры определений.';
$_['help_format']                           = 'Сделайте сначала выгрузку, что бы увидит требуемый формат листа Excel!';
?>