			 ...
			 <div class="tab-content">
				...
				<div class="tab-pane" id="tab-general-setting">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control color" type="text" name="config_background_button_send_fastorder" value="<?php echo $config_background_button_send_fastorder ?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $entry_background_button_send_fastorder_hover?></label>
						<div class="col-sm-3">
							<input class="form-control color" type="text" name="config_background_button_send_fastorder_hover" value="<?php echo $config_background_button_send_fastorder_hover ?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $entry_background_button_open_form_send_order?></label>
						<div class="col-sm-3">
							<input class="form-control color" type="text" name="config_background_button_open_form_send_order" value="<?php echo $config_background_button_open_form_send_order ?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $entry_background_button_open_form_send_order_hover?></label>
						<div class="col-sm-3">
							<input class="form-control color" type="text" name="config_background_button_open_form_send_order_hover" value="<?php echo $config_background_button_open_form_send_order_hover ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control color" type="text" name="config_color_button_open_form_send_order" value="<?php echo $config_color_button_open_form_send_order ?>"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control color" type="text" name="config_any_text_at_the_bottom_color" value="<?php echo $config_any_text_at_the_bottom_color ?>"/>
						</div>
					</div>	
					<div class="form-group">
