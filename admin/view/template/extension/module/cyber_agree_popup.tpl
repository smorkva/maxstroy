				...
				<?php foreach ($languages as $language) { ?>
					<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
						<div class="form-group">					
							...
							<div class="col-sm-10">
								<textarea class="form-control summernote" name="agreedata[<?php echo $language['language_id']; ?>][agree_description]" id="input-agree-description<?php echo $language['language_id']; ?>"><?php echo isset($agreedata[$language['language_id']]) ? $agreedata[$language['language_id']]['agree_description'] : ''; ?></textarea>
							</div>
						</div>				  
					</div>	
				<?php } ?>
...
//--></script>
<link href="view/stylesheet/cyberstore/agree_popup/font-awesome/css/font-awesome.min.css" rel="stylesheet" media="screen" />
