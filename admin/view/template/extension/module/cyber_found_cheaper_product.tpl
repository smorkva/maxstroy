...
function saveCommentManager(id_found_cheaper) {
  ...
  $.ajax({
    type: 'post',
    url:  'index.php?route=extension/module/cyber_found_cheaper_product/saveCommentManager&token=<?php echo $token; ?>&id_found_cheaper=' + id_found_cheaper + '&comment_manager=' + comment_manager,
    dataType: 'json',
    success: function(json) {
      $('#list_applications').load('index.php?route=extension/module/cyber_found_cheaper_product/list_applications&token=<?php echo $token; ?>');
    }
  });
}
function update_status() {
  $.ajax({
    type: 'post',
    url:  'index.php?route=extension/module/cyber_found_cheaper_product/update_status&token=<?php echo $token; ?>',
...
function del_selected() {
  $.ajax({
    type: 'post',
    url:  'index.php?route=extension/module/cyber_found_cheaper_product/del_selected&token=<?php echo $token; ?>',
    data: $('#list_applications input.checkbox_found_cheaper_selected[type=\'checkbox\']:checked'),
    dataType: 'json',
    success: function(json) {
