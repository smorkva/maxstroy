			...
			<?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea class="form-control summernote" name="ttn_description<?php echo $language['language_id'] ?>" id="ttn_description<?php echo $language['language_id'] ?>"><?php echo isset(${'ttn_description' . $language['language_id']}) ? ${'ttn_description' . $language['language_id']} : ''; ?></textarea>
						</div>
					</div>
				</div>
			<?php } ?>
