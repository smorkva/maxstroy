...
<script type="text/javascript" src="view/javascript/cyberstore/jscolor_menu/jscolor.js"></script>
<script>
...
function saveEditor() {	
	$.ajax({
		url: 'index.php?route=extension/module/cyber_megamenuvh<?php echo isset($sheme)?$sheme:''?>/saveStickerMenu&token=<?php echo $token;?>&megamenu_id=<?php echo $megamenu_id;?>',
		type: 'post',
		dataType: 'json',
