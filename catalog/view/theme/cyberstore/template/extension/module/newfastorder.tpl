				...
				<div class="price-quantity-quickorder text-center">
					...
					<?php } ?>
						<div class="quantity_quickorder">							
							<input type="button" id="decrease_quickorder" value="-" onclick="btnminus_quickorder(<?php if(isset($config_additional_settings_newstore['quantity_multiple']) && ($config_additional_settings_newstore['quantity_multiple'] == '1')){?><?php echo $minimum; ?><?php } else { ?>1<?php } ?>);recalculateprice_quickorder();" />
							<input type="text" class="qty_quickorder<?php if(isset($config_additional_settings_newstore['quantity_multiple']) && ($config_additional_settings_newstore['quantity_multiple'] == '1') && $minimum > 1){?> disabled_input<?php } ?>" name="quantity" id="htop_quickorder" size="2" value="<?php echo $minimum; ?>" />
							<input type="button" id="increase_quickorder" value="+" onclick="btnplus_quickorder(<?php if(isset($config_additional_settings_newstore['quantity_multiple']) && ($config_additional_settings_newstore['quantity_multiple'] == '1')){?><?php echo $minimum; ?><?php } else { ?>1<?php } ?>);recalculateprice_quickorder();" />
							<script>
