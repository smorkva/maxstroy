...
<?php if($group_editor == 'Y') { ?>	
	<span class="editor-group-checked-product btn-editprod-checkbox"><input title="<?php echo $pge_text_select_checkbox;?>" data-toggle="tooltip" class="group-editor-checkbox" type="checkbox" name="selected_productgroupeditor[]" value="<?php echo $product_id; ?>"/></span>
<?php } ?>
