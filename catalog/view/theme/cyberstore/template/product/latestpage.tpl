...
<div class="col-sm-12 content-box-cs">
  ...
  <?php if (isset($menu_open_category) && (($menu_open_category =='1') && ($main_menu =='1') && ($column_left))) { ?>
	...
	<?php echo $content_top; ?>
      ...
      <?php if ($products) { ?>
		<?php if(isset($setting_lp['status_receipt_date']) && ($setting_lp['status_receipt_date'] == 1)){?>
		<?php if($date_availeble){?>
		<div>
			<ul class="list-inline danewpod">
				<?php foreach($date_availeble as $rsd){ ?>
				<li class="list-inline-item">
					<a <?php if($date_ave == $rsd['text']){?>class="active-date"<?php } ?> href="<?php echo $rsd['href'];?>"><?php echo $rsd['text'];?></a>
				</li>
				<?php } ?>
			</ul>
		</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left localstorage" style="margin:10px 0px;">
			<div class="btn-group">
				...
				<div class="btn-group hidden-xs localstorage">
					...
					<?php if(isset($setting_lp['status_lp_price_list']) && ($setting_lp['status_lp_price_list'] == 1)){?>
        ...
        <?php foreach ($products as $product) { ?>
         <div class="product-layout product-grid <?php echo $cols_class;?>">
          <div class="product-thumb">
				...
				<?php if(isset($setting_lp['status_lp_dop_image_hover_cp']) && ($setting_lp['status_lp_dop_image_hover_cp'] == 1)){?>
					<a href="<?php echo $product['href']; ?>"><img <?php if ($product['product_quantity'] <= 0 && $show_stock_status) { ?>data-status="<?php echo $product['stock_status']; ?>"<?php } ?> <?php if($product['additional_image_hover']) { ?> data-additional-hover="<?php echo $product['additional_image_hover'];?>"<?php } ?> <?php if($lazyload_page){?>data-src="<?php echo $product['thumb']; ?>" src="<?php echo $lazy_image;?>" <?php } else { ?>src="<?php echo $product['thumb'];?>"<?php } ?> alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive <?php if($lazyload_page){?>lazyload<?php } ?>" /></a>	
				<?php } else { ?>	
					<a href="<?php echo $product['href']; ?>"><img <?php if ($product['product_quantity'] <= 0 && $show_stock_status) { ?>data-status="<?php echo $product['stock_status']; ?>"<?php } ?> <?php if($lazyload_page){?>data-src="<?php echo $product['thumb']; ?>" src="<?php echo $lazy_image;?>" <?php } else { ?>src="<?php echo $product['thumb'];?>"<?php } ?> alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive <?php if($lazyload_page){?>lazyload<?php } ?>" /></a>	
				<?php } ?>
              ...
              <div class="caption">
				...
				<?php if(isset($setting_lp['status_lp_model']) && ($setting_lp['status_lp_model'] == 1)){?>
					<div class="product-model"><?php echo $product['model']?></div>
				<?php } ?>
				<?php if(isset($setting_lp['status_lp_description']) && ($setting_lp['status_lp_description'] == 1)){?>
				...
				<?php if ($show_options) { ?>
					...
					<?php } ?>		
				<?php if(isset($setting_lp['status_lp_rating']) && ($setting_lp['status_lp_rating'] == 1)){?>
					<div class="rating">
					<span class="rating-box">
							<?php for ($i = 1; $i <= 5; $i++) { ?>
								...
								<?php } ?>
							<?php } ?>
						<?php if(isset($setting_lp['status_lp_quantity_reviews']) && ($setting_lp['status_lp_quantity_reviews'] == 1)){?>
				...
				<div class="actions">
					...
					<?php if(isset($setting_lp['status_lp_fastorder']) && ($setting_lp['status_lp_fastorder'] == 1)){?>
					...
					<?php } ?>
					<?php if(isset($setting_lp['status_lp_wishlis']) && ($setting_lp['status_lp_wishlis'] == 1)){?>
					...
					<?php } ?>
					<?php if(isset($setting_lp['status_lp_compare']) && ($setting_lp['status_lp_compare'] == 1)){?>
