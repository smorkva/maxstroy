<?php echo $header; ?>
<div class="container">
<div class="col-sm-12 content-box-cs <?php if (isset($menu_open_special) && (($menu_open_special =='1') && ($main_menu =='1') && ($column_left))) { ?>mtopm10<?php } ?>">
         ...
         <div class="product-layout product-grid <?php echo $cols_class;?>">
          <div class="product-thumb">
			<div class="image">	
				...
				<?php if($status_additional_image_hover_sp =='1') { ?>
