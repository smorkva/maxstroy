<?php echo $header; ?>
<div class="container">
<div class="col-sm-12 content-box-cs <?php if (isset($menu_open_manufacturer) && (($menu_open_manufacturer =='1') && ($main_menu =='1') && ($column_left))) { ?>mtopm10<?php } ?>">
  <ul class="breadcrumb <?php if (isset($menu_open_manufacturer) && (($menu_open_manufacturer =='1') && ($main_menu =='1') && ($column_left))) { ?>col-md-offset-3 col-lg-offset-3<?php } ?>" itemscope itemtype="https://schema.org/BreadcrumbList">
  ...
  <div class="row">
 <?php if (isset($menu_open_manufacturer) && (($menu_open_manufacturer =='1') && ($main_menu =='1') && ($column_left))) { ?>
		<script>
        ...
        <div class="product-layout product-grid <?php echo $cols_class;?>">
          <div class="product-thumb">
            <div class="image">
				...
				<?php if($status_additional_image_hover_mp =='1') { ?>
