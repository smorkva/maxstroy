...
<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;margin-top: 10px;">
  ...
  <tbody>
    <tr>
      ...
      <?php if(isset($data_buyer['name_field']) && ($data_buyer['name_field'] !='')){?><b><?php echo $text_name_fields; ?>:</b> <?php echo $data_buyer['name_field']; ?><br/><?php } ?>
      <?php if(isset($data_buyer['telephone_field']) && ($data_buyer['telephone_field'] !='')){?><b><?php echo $text_telephone_field; ?>:</b> <?php echo $data_buyer['telephone_field']; ?><br/><?php } ?>
      <?php if(isset($data_buyer['comment_field']) && ($data_buyer['comment_field'] !='')){?><b><?php echo $text_comment_field; ?>:</b> <?php echo $data_buyer['comment_field']; ?><br/><?php } ?>
      <?php if(isset($data_buyer['email_field']) && ($data_buyer['email_field'] !='')){?><b><?php echo $text_email_field; ?>:</b> <?php echo $data_buyer['email_field']; ?><br/><?php } ?>
      </td>
