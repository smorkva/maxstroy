...
$( "#horizontal-menu a.dropdown-toggle" ).bind( "click", function() {
	if(($(this).attr('href')!="javascript:void(0);")&&($( document ).width()>991))
	{
	window.document.location=$(this).attr('href');
	}
});
...
function nsmenu_menu(){
	$(".nsmenu-bigblock").css('width',$("#horizontal-menu .collapse").outerWidth());
	$('#horizontal-menu .dropdown-menu').each(function() {
		var menu = $('#horizontal-menu .collapse').offset();
		var dropdown = $(this).parent().offset();		
		var i = (dropdown.left + $(this).outerWidth()) - (menu.left + $('#horizontal-menu .collapse').outerWidth());
	...
	$('#grid-view').click(function() {
		...
		if (cols == 2) {
			...
			$('#content .product-layout').attr('class', 'product-layout product-grid col-lg-4 col-md-4 col-sm-6');
		} else {
			$('#content .product-layout').attr('class', 'product-layout product-grid col-lg-3 col-md-3 col-sm-6');
		}
