  ...
  public function validateForm() {
    ...
    if (!isset($json['error'])) {
      ...
      if (!empty($qadata['email_question_answer'])) {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/mail/question_answer_mail.tpl')) {
          $html = $this->load->view($this->config->get('config_template').'/template/mail/question_answer_mail.tpl', $html_qadata);
        } else {
          $html = $this->load->view('default/template/mail/question_answer_mail.tpl', $html_qadata);
        }
		} else {
