...
$_['text_status_4'] = 'Заморожено';
$_['text_status_5'] = 'Мир';
$_['text_status_6'] = 'Чекає';
...
$_['text_transaction_suspended_failed'] = 'Заморожений через помилку оплати';
$_['text_transaction_outstanding_failed'] = 'Несплачений через помилку оплати';
$_['text_transaction_expired'] = 'Мир';




$_['text_empty'] = 'Періодичні платежі не знайдені';
$_['text_error'] = 'Періодичні замовлення не знайдені!';
...
$_['text_cancelled'] = 'Періодичний платіж було скасовано';
...
$_['error_not_found'] = 'Не можна вимкнути профіль';
