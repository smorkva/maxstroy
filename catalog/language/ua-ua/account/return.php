...
$_['text_agree'] = 'Я прочитав <a href="%s" class="agree"><b>%s</b></a> і погоджується з умовами ';

$_['button_submit'] = 'Надіслати запит';
...
$_['entry_captcha'] = 'Введіть зображення з зображення';
