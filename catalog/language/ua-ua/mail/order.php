...
$_['text_new_greeting'] = 'Дякую за інтерес до товарів %s . Ваше замовлення отримано та надійде в обробку найближчим часом';
...
$_['text_new_download'] = 'Після підтвердження оплати, завантажені товари будуть доступні за посиланням:';
