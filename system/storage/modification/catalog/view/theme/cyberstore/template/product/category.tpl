<?php echo $header; ?>
<div class="container">
<div class="col-sm-12 content-box-cs <?php if (isset($menu_open_category) && (($menu_open_category =='1') && ($main_menu =='1') && ($column_left))) { ?>mtopm10<?php } ?>">
  ...
  <div class="row">
	...
	<?php $cols_class = 'col-lg-6 col-md-6 col-sm-12';?>
    <?php } elseif ($column_left || $column_right) { ?>
    <?php $class = 'col-sm-8 col-md-9'; ?>
	<?php $cols_class = 'col-lg-4 col-md-4 col-sm-6'; ?>
    <?php } else { ?>
    <?php $class = 'col-sm-12'; ?>
	<?php $cols_class = 'col-lg-3 col-md-3 col-sm-6'; ?>
    <?php } ?>
			...
			<div class="col-sm-6 col-md-4 col-lg-3">  	
				<div class="thumbnail subcategory">
					<a href="<?php echo $category['href']; ?>">
						<?php if($show_subcategories_image == 1) { ?><div><img alt="<?php echo $category['name']; ?>" src="<?php echo $category['thumb']; ?>"></div><?php } ?>
						<div class="name-wrapper">
							<div class="display-table">
								<div class="display-table-cell"><?php echo $category['name']; ?></div>
							</div>
						</div>
					</a>
				</div>
        ...
        <?php foreach ($products as $product) { ?>
         <div class="product-layout product-grid <?php echo $cols_class;?>">
          <div class="product-thumb">
				...
				<?php if($status_additional_image_hover_cp =='1') { ?>
