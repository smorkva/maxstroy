        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <fieldset>
            ...
            <div class="row">
			 ...
			 <td class="text-center"><span data-toggle="tooltip" title="<?php echo $help_mob_device; ?>"><?php echo $text_mob_device; ?></span>
			 ...
			 <td class="text-center"><div class="btn-group mob-device"><label><input type="checkbox" name="layout_module[<?php echo $module_row; ?>][mob_device]" value="1" <?php if(isset($layout_module['mob_device']) && ($layout_module['mob_device'] == 1)){?> checked="checked"<?php } ?>/><i class="fa fa-power-off"></i></label><label><input type="checkbox" name="layout_module[<?php echo $module_row; ?>][tablet_device]" value="1" <?php if(isset($layout_module['tablet_device']) && ($layout_module['tablet_device'] == 1)){?> checked="checked"<?php } ?>/><i class="fa fa-power-off"></i></label><label><input type="checkbox" name="layout_module[<?php echo $module_row; ?>][pc_device]" value="1" <?php if(isset($layout_module['pc_device']) && ($layout_module['pc_device'] == 1)){?> checked="checked"<?php } ?>/><i class="fa fa-power-off"></i></label></div></td>
...
function addModule(type) {
	...
	html += '<td class="text-center"><div class="btn-group mob-device"><label><input type="checkbox" name="layout_module[' + module_row + '][mob_device]" value="1"><i class="fa fa-power-off"></i></label><label><input type="checkbox" name="layout_module[' + module_row + '][pc_device]" value="1"/><i class="fa fa-power-off"></i></label><label><input type="checkbox" name="layout_module[' + module_row + '][tablet_device]" value="1"/><i class="fa fa-power-off"></i></label></div></td>';
