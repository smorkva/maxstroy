  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<!--added--><td class="left"><input class="form-control color" type="text" value="<?php echo $order_status['row_color']; ?>" name="colorbox" onChange="setOrderStatusColor(<?php echo $order_status['order_status_id']; ?>, this.value)" /></td>
		<!--added--><td class="left"><input class="form-control color" type="text" value="<?php echo $order_status['row_color_text']; ?>" name="colorbox_text" onChange="setOrderStatusColorText(<?php echo $order_status['order_status_id']; ?>, this.value)" /></td>
