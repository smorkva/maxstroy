<nav id="column-left">
  ...
  <ul id="menu">
    ...
    <li id="<?php echo $menu['id']; ?>">
      <?php if ($menu['href']) { ?>
      <a href="<?php echo $menu['href']; ?>"><?php if($menu['id'] == 'menu-cyberstore'){ ?><i><img src="<?php echo $menu['icon']; ?>" /></i><?php } else { ?><i class="fa <?php echo $menu['icon']; ?> fw"></i><?php } ?> <span><?php echo $menu['name']; ?></span></a>
      <?php } else { ?>
      <a class="parent"><?php if($menu['id'] == 'menu-cyberstore'){ ?><i><img src="<?php echo $menu['icon']; ?>" /></i><?php } else { ?><i class="fa <?php echo $menu['icon']; ?> fw"></i><?php } ?> <span><?php echo $menu['name']; ?></span></a>
      <?php } ?>
