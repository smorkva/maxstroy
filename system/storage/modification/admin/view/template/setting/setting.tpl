          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
				...
				<div class="form-group">
				  ...
				  <span data-toggle="tooltip" title="<?php echo $help_callback_agree; ?>"><?php echo $entry_callback_agree; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_callback_id" id="input-callback-agree" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_callback_id) { ?>
				...
				<div class="form-group">
				  ...
				  <span data-toggle="tooltip" title="<?php echo $help_quickorder_agree; ?>"><?php echo $entry_quickorder_agree; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_quickorder_id" id="input-quickorder-agree" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_quickorder_id) { ?>
                      <option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
                      <?php } ?>
				...
				<div class="form-group">
				  ...
				  <span data-toggle="tooltip" title="<?php echo $help_foundcheaper_agree; ?>"><?php echo $entry_foundcheaper_agree; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_foundcheaper_id" id="input-foundcheaper-agree" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_foundcheaper_id) { ?>
                      <option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
                      <?php } ?>
