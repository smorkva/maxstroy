            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-product<?php echo $product_tab_row; ?>">
                ...
                <ul class="nav nav-tabs" id="product_tab_description_div<?php echo $product_tab_row; ?>">
                  <?php foreach ($languages as $language) { ?>
                  <li><a href="#extra_tab_description<?php echo $product_tab_row; ?><?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                  <?php } ?>
                </ul>
                <div class="tab-content">
                  <?php foreach ($languages as $language) { ?>
                  <div class="tab-pane" id="extra_tab_description<?php echo $product_tab_row; ?><?php echo $language['language_id']; ?>">
                    <textarea class="form-control summernote" name="product_tab_ns[<?php echo $product_tab_row; ?>][product_tab_ns_description][<?php echo $language['language_id']; ?>][text]" placeholder="<?php echo $entry_text; ?>" class="form-control summernote"><?php echo isset($product_tab_ns['product_tab_ns_description'][$language['language_id']]) ? $product_tab_ns['product_tab_ns_description'][$language['language_id']]['text'] : ''; ?></textarea>
                  </div>
                  <?php } ?>
                </div>
              </div>
              ...
              'select': function(item) {
                html  = '<div class="tab-pane" id="tab-product'+product_tab_row+'">';
                  ...
                  html  += '<ul class="nav nav-tabs" id="product_tab_description_div'+product_tab_row+'">';
                    <?php foreach ($languages as $language) { ?>
                    html  += '<li><a href="#extra_tab_description'+product_tab_row+'<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
                    <?php } ?>
                  html  += '</ul>';
                  html  += '<div class="tab-content">';
                    <?php foreach ($languages as $language) { ?>
                    html  += '<div class="tab-pane" id="extra_tab_description'+product_tab_row+'<?php echo $language['language_id']; ?>">';
                      html  += '<textarea name="product_tab_ns['+product_tab_row+'][product_tab_ns_description][<?php echo $language['language_id']; ?>][text]" placeholder="<?php echo $entry_text; ?>" class="form-control summernote_ptabs"></textarea>';
                    html  += '</div>';
                    <?php } ?>
                  html  += '</div>';
                html  += '</div>';
