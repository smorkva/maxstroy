	...
	public function delete() {
		...
		$this->getList();
				...
				private function sendMail($number_ttn, $email_user, $order_id) {
					...
					$subject = $this->model_extension_module_cyber_ordersetting->getCustomFields($order_info, $this->config->get('ttn_subject' . $order_info['language_id']));
					$html_message  = $this->model_extension_module_cyber_ordersetting->getCustomFields($order_info, $this->config->get('ttn_description' . $order_info['language_id']));
