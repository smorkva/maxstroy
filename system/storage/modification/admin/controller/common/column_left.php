...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		$syberstore[] = array(
			...
			'href'     => $this->url->link('extension/module/cyber_setting_theme', 'token=' . $this->session->data['token'], true),
			'children' => array()
		);
		$syberstore[] = array(
			'name'	   => $this->language->get('text_add_demo'),
			'href'     => $this->url->link('cyberstore/cyberstoredemo', 'token=' . $this->session->data['token'], true),
			'children' => array()		
		);
		...
		$syberstore[] = array(
			...
			'href'     => $this->url->link('extension/module/cyber_question_answer', 'tablist=1&token=' . $this->session->data['token'], true),
			'children' => array()
		);
		...
		$syberstore[] = array(
			...
			'href'     =>  $this->url->link('extension/module/cyber_found_cheaper_product', 'tablist=1&token=' . $this->session->data['token'], true),
			'children' => array()
		);
		}
        ...
        $tabs_product_on_off = $this->config->get('tabs_product_on_off');
			...
			if ($this->user->hasPermission('access', 'catalog/reviews_store')) {
				$reviews_store[] = array(
					...
					'href'     => $this->url->link('catalog/reviews_store', 'token=' . $this->session->data['token'], true),
					'children' => array()	
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/reviews_store')) {
				$reviews_store[] = array(
					...
					'href'     => $this->url->link('catalog/reviews_store/setting', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
		...
		if ($syberstore) {
				$data['menus'][] = array(
					'id'       => 'menu-cyberstore',
					'icon'	   => 'view/image/CyberStore_icon.png',
